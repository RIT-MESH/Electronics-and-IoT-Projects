...
const char* password = "Success7183!";          // Provide Password


const char* host = "a1cc0nomzey2wg-ats.iot.ap-south-1.amazonaws.com"; //AWS IoT Core--> Settings (Device data endpoint)
...
//  
  ...
  char fakeData[256]; 
//  float temperature = t;  //fake number range, adjust as you like  
//  float humidity =    h;  //You can use decimal instead of floats to save mem space
  float temperature =  random(55,77); //fake number range, adjust as you like
